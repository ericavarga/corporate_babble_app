...
if st.button("Generate Phrase"):
    ...
    # JS and input field to copy to clipboard
    st.markdown(f"""
        <input type="text" value="{phrase}" id="copyText" readonly style="position: absolute; left: -9999px;">
        <button class="copy-button" onclick="copyText()">📋 Copy to Clipboard</button>
        <p id="copiedMsg">✔️ Copied to clipboard!</p>
        <script>
            function copyText() {{
