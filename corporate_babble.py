...
if st.button("Generate Phrase"):
    ...
    # Copy to clipboard button and confirmation message
    st.markdown(f"""
        <input type="text" value="{phrase}" id="copyText" style="position:absolute; left:-1000px;">
        ...
        <p id="copiedMsg" style="color: green; display: none; margin-top: 5px;">✔️ Copied to clipboard!</p>
